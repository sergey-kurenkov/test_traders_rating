...
src/traders_rating/get_time.o: src/traders_rating/get_time.h src/traders_rating/get_time.cpp Makefile
	g++ -std=c++11 -I ./src -g -c src/traders_rating/get_time.cpp -o src/traders_rating/get_time.o
